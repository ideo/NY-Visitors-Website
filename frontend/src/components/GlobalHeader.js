        ...
        <div className="_modal-menu serif flex flex-column justify-around">
          <nav className="flex flex-column items-end tr pa5">
            <Link
              to="#get-here"
              onClick={toggleMenu}
              className="_modal-menu-link _get-here outline items-center justify-center flex black link f2 pa3">
              Get here
            </Link>
            <Link
              to="#around-studio"
              onClick={toggleMenu}
              className="_modal-menu-link _around-studio outline items-center justify-center flex black link f2 pa3">
              Around the Studio
            </Link>
            <Link 
              to="#in-studio"
              onClick={toggleMenu}
              className="_modal-menu-link _in-studio outline items-center justify-center flex black link f2 pa3">
              In the Studio
            </Link>
          </nav>
        </div>
